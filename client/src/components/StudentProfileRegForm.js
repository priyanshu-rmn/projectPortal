...
function StudentProfileRegForm(props) {
  ...
  if (rd) {
    ...
    return (
      ...
      <form onSubmit={submitHandler} className="input-group mb-3"  style={{ width:"50%"}}>
        ...
        <div className="input-group flex-nowrap">
          ...
          <input className="form-control" type="text" name="fName" id="fName" defaultValue={props.user.username} ref={fNameInputRef} />
        </div>
        </div>
        ...
        <input className="form-control" type="text" name="lName" id="lName" defaultValue={props.user.username} ref={lNameInputRef} />
      </div>
      </div>
      ...
      <div className="input-group flex-nowrap">
        <div className="input-group-prepend">
          <span className="input-group-text" id="addon-wrapping">Resume Link  </span>
        </div>
        <input className="form-control" type="text" name="resumeLink" id="resumeLink" ref={resumeLinkInputRef} />
      </div>
      </div>
      ...
      <div className="input-group flex-nowrap">
        <div className="input-group-prepend">
          <span className="input-group-text" id="addon-wrapping">Email Id </span>
        </div>
        <input
      ...
      <div className="input-group flex-nowrap">
        <div className="input-group-prepend">
          <span className="input-group-text" id="addon-wrapping">Current CPI  </span>
        </div>
        <input
          className="form-control"
            type="number"
      ...
      <div className="input-group flex-nowrap">
        ...
        <input className="form-control" type="tel" name="contactNo" id="contactNo" required ref={contactNoInputRef} />
      </div>
      </div>
      ...
      <div className="input-group flex-nowrap">
        <div className="input-group-prepend">
          <span className="input-group-text" id="addon-wrapping">Roll Number  </span>
        </div>
        <input className="form-control" type="text" name="rollNo" id="rollNo" required ref={rollNoInputRef} />
      </div>
      </div>

        <button as={Link} to="/s/dashboard" type="submit" className="btn btn-success" >CONTINUE</button>
